...
export default function NavBar({props}: any) {
    ...
    return (
        <nav className="bg-zinc-900">
            <div className='flex items-center justify-between flex-wrap p-6 container mx-auto'>
                ...
                <div className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto lg:show ${drawerStatus}`}>
                    <div className="text-sm lg:flex-grow">
                        <Link href="/" className="block mt-4 lg:inline-block lg:mt-0 text-sky-500 hover:text-white mr-4">
                            Home
                        </Link>
                        <Link href="/AddElementTestPage" className="block mt-4 lg:inline-block lg:mt-0 text-sky-500 hover:text-white mr-4">
                            Features
                        </Link>
